...
def estimate_portion_weight(food_name: str, portion_info: Optional[str] = None) -> float:
...
def is_food_related_message(text: str) -> bool:
    ...
    food_keywords = [
        ...
        'калории', 'белки', 'жиры', 'углеводы', 'бжу',
        'диета', 'питание', 'рацион', 'продукт',
        'готовить', 'есть', 'кушать', 'съел', 'поел'
    ]
