...
def get_profile_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text="🔄 Пересчитать нормы",
            callback_data="recalculate_norms"
        )
    )
    builder.row(
        InlineKeyboardButton(
...
def get_activity_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            ...
            callback_data="activity_lightly_active"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="🏃 Умеренная активность",
            callback_data="activity_moderately_active"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="💪 Высокая активность",
            callback_data="activity_very_active"
        )
    )
    builder.row(
        InlineKeyboardButton(
...
def get_goal_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            ...
            callback_data="goal_maintain_weight"
        )
    )
    builder.row(
        InlineKeyboardButton(
            text="💪 Набор мышечной массы",
            callback_data="goal_weight_gain"
        )
    )
    builder.row(
        InlineKeyboardButton(
