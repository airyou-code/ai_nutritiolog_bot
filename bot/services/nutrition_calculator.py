...
class NutritionCalculator:
    ...
    def calculate_bmr(self, user: TelegramUser) -> Optional[float]:
        """
    ...
    def calculate_tdee(self, user: TelegramUser) -> Optional[float]:
    ...
    def calculate_target_calories(self, user: TelegramUser) -> Optional[float]:
    ...
    def calculate_macros(self, user: TelegramUser) -> Optional[Dict[str, float]]:
        """
