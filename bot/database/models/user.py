...
from sqlalchemy import BigInteger, DateTime, String, Boolean, Integer, Float
...
class TelegramUser(Base):
    ...
    activity_level: Mapped[str | None] = mapped_column(String(20), nullable=True)  # sedentary, lightly_active, etc.
    goal: Mapped[str | None] = mapped_column(String(20), nullable=True)  # weight_loss, weight_gain, maintain_weight
